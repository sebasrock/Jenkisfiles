pipeline {
  ...
  parameters {
    string(name: 'THREADS', defaultValue: '10 20 60', description: '''e.g. 10 <br>
                                e.g. 10 20 40 80
    ...
    string(name: 'PAYLOAD_SIZES', defaultValue: '1KB 10KB 100KB', description: 'e.g. 1KB 10KB 100KB 500KB 1MB <br>')
    ...
    string(name: 'MULE_BUILD', defaultValue: 'DEFAULT', description: '''mule-enterprise-standalone-4.2.0-SNAPSHOT
